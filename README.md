...
- [Data Flow](#-data-flow) (incomplete ⚠️)
- [Data Schema](#-data-schema) (incomplete ⚠️)
...
### 🏗️ Data Architecture
---
<img width="981" height="641" alt="Image" src="https://github.com/user-attachments/assets/acd1df71-877a-4ad4-9933-921d40b5619e" />

### 📐 Data Flow
---
The chart below is a preliminary view of the data flow diagram. Please note that the project is still ongoing and thus, this chart is still **INCOMPLETE.**

<img width="762" height="602" alt="Image" src="https://github.com/user-attachments/assets/2eb5337b-1ca6-4a6a-b038-ed92f1edd4c4" />

### 📂 Data Schema
---
The chart below is a preliminary view of the data schema. Only primary & foreign keys were shown to create an initial schema. Please note that the project is still ongoing and thus, this chart is still **INCOMPLETE.**

<img width="1137" height="597" alt="Image" src="https://github.com/user-attachments/assets/02b73830-36be-4ee1-915c-b6b44251f15c" />
